...
class LogosControllerTest < ActionController::TestCase
  ...
  test "should create logo" do
    assert_difference('Logo.count') do
      post :create, logo: { companyID: @logo.companyID, company_id: @logo.company_id, description: @logo.description, url: @logo.url }
    end
  ...
  test "should update logo" do
    patch :update, id: @logo, logo: { companyID: @logo.companyID, company_id: @logo.company_id, description: @logo.description, url: @logo.url }
    assert_redirected_to logo_path(assigns(:logo))
  end
